...
![Рис. 9. Эпюра время-расстояние, анимация](cargo_anim.gif)<br>
...
![Рис. 10. Распределение весов среди варьируемых критериев при помощи случайного леса](cargo_anim.gif)<br>
*Рис. 10. Распределение весов среди варьируемых критериев при помощи случайного леса*

![Рис. 11. Коэффициенты корреляции Пирсона для варьируемых критериев](cargo_anim.gif)<br>
